                ...
                InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(7.0, 40.0, 0.0, 0.0),
                        child: Text(
                          'Perfil',
                          style:
                  ...
                  Card(
                    ...
                    child: TextFormField(
                      ...
                      onFieldSubmitted: (_) async {
                        _model.palavra = _model.textController.text;
                        setState(() {});
                      },
                      autofocus: true,
                      obscureText: false,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder<ApiCallResponse>(
                            future: BuscarShowsCall.call(
                              nome: 'ilike.%${_model.palavra}%',
                            ),
                            builder: (context, snapshot) {
                              ...
                              final listViewBuscarShowsResponse =
                                  snapshot.data!;
                              return Builder(
                                builder: (context) {
                                  final lvItens =
                                      (listViewBuscarShowsResponse.jsonBody
                                                      .toList()
                                                      .map<DtshowsStruct?>(
                                                          DtshowsStruct
                                                              .maybeFromMap)
                                                      .toList()
                                                  as Iterable<DtshowsStruct?>)
                                              .withoutNulls
                                              ?.toList() ??
                                          [];
