...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.emailCadastTextController ??= TextEditingController();
    _model.emailCadastFocusNode ??= FocusNode();
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 60.0, 0.0, 32.0),
                  child: Container(
                    width: 374.0,
                    height: 70.0,
                    decoration: BoxDecoration(
                        ...
                        children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: _model
                                          .dataNascTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              width: double.infinity,
                              child: TextFormField(
                                controller: _model.emailCadastTextController,
                                focusNode: _model.emailCadastFocusNode,
                                autofocus: true,
                                autofillHints: [AutofillHints.email],
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                validator: _model
                                    .emailCadastTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                final user =
                                  ...
                                  context,
                                  _model.emailCadastTextController.text,
