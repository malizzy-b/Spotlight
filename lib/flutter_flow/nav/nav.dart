      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : CartPageWidget(
                  nome: params.getParam<ShowsShowRow>(
                    'nome',
                    ParamType.SupabaseRow,
                  ),
                  data: params.getParam<ShowsShowRow>(
                    'data',
                    ParamType.SupabaseRow,
                  ),
                  preco: params.getParam<ShowsShowRow>(
                    'preco',
                    ParamType.SupabaseRow,
                  ),
                ),
